        ...
        case 'getCroppedCanvas':
          if (result) {
            ...
            if (!$download.hasClass('disabled')) {
              ...
              parent.parent.document.getElementById('uploadImageAvatar').innerHTML = result.toDataURL();
              //console.log(parent.parent.document.getElementById('testLabelUpload').innerHTML);
              pred = parent.parent.document.getElementById('uploadImageAvatar').innerHTML;
              console.log (pred);
